...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.textColor = isSelected ? BMb2b_sub_color1 : BM_ADDRESS_PICKER_333333;
...
//    [self.cancelButton addTarget:self action:@selector(cancelAction:) forControlEvents:UIControlEventTouchUpInside];
    ...
    self.hightlightedBlockView.backgroundColor = BMb2b_sub_color1;
...
- (void)setSelectedTitleButtonWithTag:(NSInteger)tag title:(NSString *)title {
    ...
    [button setTitleColor:BMb2b_sub_color1 forState:UIControlStateNormal];
